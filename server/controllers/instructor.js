...
export const makeInstructor = async (req, res) => {
  try {
    ...
    //if users don't have the stripe_account_id yet, then create new
    ...
    //create account link based on the account id( for frontend to complete onboarding)
    ...
    //then send the account link as a response to frontend
