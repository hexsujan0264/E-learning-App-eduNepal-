...
const CourseView = () => {
  ...
  const handleVideo = async (e) => {
    try {
      ...
      //Work on progress bar and send video as form data to the backend
      const { data } = await axios.post(
  ...
  const handlePublish = async (e, courseId) => {
    try {
      ...
      toast("Try Again!!! Failed to publish the course.");
    }
  };
  ...
  const handleUnpublish = async (e, courseId) => {
    try {
      ...
      setCourse(data);
      toast("Course is not unpublished.");
    } catch (err) {
      toast("Try Again!!! Failed to publish the course.");
    }
  };
              ...
              <div className="media-body pl-2">
                <div className="row">
                  ...
                  <div className="row pt-2">
                    ...
                    <div className="col" style={{ marginLeft: "70rem" }}>
                    ...
                    {/* <div className="col">
                      <Tooltip title="Publish">
                        <CheckOutlined
                          className="h5 pointer text-danger ml-5"
